...
public class TestProduktBatchCompValidator {
	...
	private IProductBatchCompValidator proBatComValidator;

	@Before
	public void setUp() throws Exception {
		proBatComValidator = new ProductBatchCompValidator();
	}

	@After
	public void tearDown() throws Exception {
		proBatComValidator = null;
	...
	public void testIsproBatIdValidPositive00() {
		...
		boolean actual = proBatComValidator.isPbIdValid(proBatId);
	...
	public void testIsraaBatIdValidPositive00() {
		...
		boolean actual = proBatComValidator.isPbIdValid(raaBatId);
		boolean expected = true;
	...
	public void testIsTareValidPositive00() {
		...
		boolean actual = proBatComValidator.isTareValid(isTare);
		boolean expected = true;
	...
	public void testIsNettoValidPositive00() {
		...
		boolean actual = proBatComValidator.isNettoValid(isNetto);
		boolean expected = true;
	...
	public void testIsOprIdValidPositive00() {
		...
		boolean actual = proBatComValidator.isOprIdValid(oprId);
		boolean expected = true;
	...
	public void testIsPbcStatusValidPositive00() {
		...
		boolean actual = proBatComValidator.isPbcStatusValid(oprStatus);
		boolean expected = true;
