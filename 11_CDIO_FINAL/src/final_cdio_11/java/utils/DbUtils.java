...
public class DbUtils {
	...
	private static void createSampleReceptKomponent() throws SQLException {
		...
		connector.getConnection().prepareStatement("INSERT INTO receptkomponent(recept_id, raavare_id, nom_netto, tolerance, status) VALUES (1, 1, 0.5, 0.1, 0), (1, 2, 0.5, 0.1, 0), (1, 5, 0.5, 0.1, 0), (2, 1, 0.5, 0.1, 0), (2, 3, 0.5, 0.1, 0), (2, 5, 1.0, 0.1, 0), (2, 6, 1.0, 0.1, 0), (3, 1, 0.5, 0.1, 0), (3, 4, 1.5, 0.1, 0), (3, 5, 1.0, 0.1, 0), (3, 6, 1.0, 0.1, 0), (3, 7, 1.0, 0.1, 0);").executeUpdate();
		if (utils.DEV_ENABLED) utils.logMessage("Done.");
	}
